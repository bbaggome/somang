...
3. **stores**: 판매점(가맹점) 정보
4. **promotions**: 판매점의 프로모션 정보
5. **quote_requests**: 소비자의 견적 요청서
6. **quotes**: 판매점이 제출한 표준 견적서
7. **reviews**: 거래 완료 후 소비자가 작성하는 리뷰
8. **review_votes**: 리뷰에 대한 '좋아요/싫어요' 투표
9. **favorites**: 사용자의 '찜하기' 정보
10. **chat_rooms**: 소비자와 판매점 간의 1:1 채팅방
11. **chat_messages**: 채팅방 내의 메시지 기록
12. **notices**: 플랫폼 전체 공지사항
13. **policies**: 버전 관리되는 서비스 약관
14. **policy_consents**: 사용자의 약관 동의 이력
15. **support_tickets**: 사용자 1:1 문의
16. **ticket_replies**: 1:1 문의에 대한 답변
