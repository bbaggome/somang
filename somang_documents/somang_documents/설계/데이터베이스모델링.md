...
COMMENT ON COLUMN public.stores.zip_code IS 'Zip code of the store address.';
COMMENT ON COLUMN public.stores.base_address IS 'Base part of the store address.';
COMMENT ON COLUMN public.stores.detail_address IS 'Detailed part of the store address.';
COMMENT ON COLUMN public.stores.latitude IS 'Latitude of the store location.';
COMMENT ON COLUMN public.stores.longitude IS 'Longitude of the store location.';
...
COMMENT ON COLUMN public.stores.response_rate IS 'Cache column for the store''s quote response rate.';
COMMENT ON COLUMN public.stores.chat_room_count IS 'Cache column for the total number of chats.';
COMMENT ON COLUMN public.stores.accepted_quote_count IS 'Cache column for the number of accepted quotes.';
...
COMMENT ON COLUMN public.reviews.is_hidden IS 'Flag to hide the review from public view by an admin.';
...
COMMENT ON COLUMN public.chat_messages.message_type IS 'Type of the message: text or image.';
COMMENT ON COLUMN public.chat_messages.attachment_url IS 'URL of the attachment if message_type is not text.';
