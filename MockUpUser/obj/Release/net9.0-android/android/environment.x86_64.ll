...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x0bad4c4ea6fa9364, ; from name: libaot-MockUpUser.so
		i64 u0xfd8e158391b2caf6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MockUpUser.dll.so
		ptr null; void* handle
	}, ; 45
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x49ac4f0a47c216db, ; from name: MockUpUser
		i64 u0xfd8e158391b2caf6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MockUpUser.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7e8243e0b531ef47, ; from name: aot-MockUpUser
		i64 u0xfd8e158391b2caf6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MockUpUser.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa19f0179049f03d2, ; from name: MockUpUser.dll.so
		i64 u0xfd8e158391b2caf6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MockUpUser.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb93c864e420f64e6, ; from name: aot-MockUpUser.so
		i64 u0xfd8e158391b2caf6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MockUpUser.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xcdcbd9e4f5587324, ; from name: MockUpUser.so
		i64 u0xfd8e158391b2caf6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MockUpUser.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xec121961606d6017, ; from name: libaot-MockUpUser
		i64 u0xfd8e158391b2caf6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MockUpUser.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf264159c7d29ed78, ; from name: aot-MockUpUser.dll.so
		i64 u0xfd8e158391b2caf6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MockUpUser.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xfd8e158391b2caf6, ; from name: libaot-MockUpUser.dll.so
		i64 u0xfd8e158391b2caf6, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MockUpUser.dll.so
		ptr null; void* handle
...
@dso_apk_entries = dso_local local_unnamed_addr global [91 x %struct.DSOApkEntry] zeroinitializer, align 16
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [118 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.mockupuser\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [25 x i8] c"libaot-MockUpUser.dll.so\00", align 16
...
@.DSOCacheEntry.68_name = private unnamed_addr constant [36 x i8] c"libaot-System.Net.Primitives.dll.so\00", align 16
@.DSOCacheEntry.69_name = private unnamed_addr constant [34 x i8] c"libaot-System.Net.Requests.dll.so\00", align 16
@.DSOCacheEntry.70_name = private unnamed_addr constant [38 x i8] c"libaot-System.Numerics.Vectors.dll.so\00", align 16
@.DSOCacheEntry.71_name = private unnamed_addr constant [33 x i8] c"libaot-System.ObjectModel.dll.so\00", align 16
@.DSOCacheEntry.72_name = private unnamed_addr constant [33 x i8] c"libaot-System.Private.Uri.dll.so\00", align 16
@.DSOCacheEntry.73_name = private unnamed_addr constant [33 x i8] c"libaot-System.Private.Xml.dll.so\00", align 16
@.DSOCacheEntry.74_name = private unnamed_addr constant [45 x i8] c"libaot-System.Runtime.InteropServices.dll.so\00", align 16
@.DSOCacheEntry.75_name = private unnamed_addr constant [36 x i8] c"libaot-System.Runtime.Loader.dll.so\00", align 16
...
@.DSOCacheEntry.79_name = private unnamed_addr constant [40 x i8] c"libaot-System.Text.Encodings.Web.dll.so\00", align 16
@.DSOCacheEntry.80_name = private unnamed_addr constant [31 x i8] c"libaot-System.Text.Json.dll.so\00", align 16
@.DSOCacheEntry.81_name = private unnamed_addr constant [45 x i8] c"libaot-System.Text.RegularExpressions.dll.so\00", align 16
@.DSOCacheEntry.82_name = private unnamed_addr constant [38 x i8] c"libaot-System.Threading.Thread.dll.so\00", align 16
@.DSOCacheEntry.83_name = private unnamed_addr constant [31 x i8] c"libaot-System.Threading.dll.so\00", align 16
@.DSOCacheEntry.84_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 16
@.DSOCacheEntry.85_name = private unnamed_addr constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 16
@.DSOCacheEntry.86_name = private unnamed_addr constant [21 x i8] c"libaot-System.dll.so\00", align 16
@.DSOCacheEntry.87_name = private unnamed_addr constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 16
@.DSOCacheEntry.88_name = private unnamed_addr constant [35 x i8] c"libaot-Mono.Android.Runtime.dll.so\00", align 16
@.DSOCacheEntry.89_name = private unnamed_addr constant [27 x i8] c"libaot-Mono.Android.dll.so\00", align 16
@.DSOCacheEntry.90_name = private unnamed_addr constant [37 x i8] c"libaot-System.Private.CoreLib.dll.so\00", align 16
